...
class TestApp(EClient, EWrapper):
    ...
    def start(self):
        ...
        # Order Type: Limit On Close Order
        # Explanation: Submitted at the close and will execute if the closing price is at or better than the submitted limit price.
        # General Link: https://www.interactivebrokers.com/en/trading/ordertypes.php?m=limitCloseModal
